    ...
    <body>
            ...
            <div class="row">
                <c:forEach var="p" items="${productos}">
                    <c:if test="${p.getEstado() == 'ACTIVO'}">
                        <c:if test="${p.getNombres() == 'Tarjeta Madre de Edicion'}">
                            <c:if test="${p.getCategoria() == 'EDICION'}">
                                <div class="col-sm-4">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-footer">
                                                ...
                                                <div class=" col-sm-12 text-center">                                
                                                    <a href="Controlador?accion=AgregarCarritoEdicion&id=${p.getId()}" class="btn btn2 btn-outline-primary">Agregar a Carrito<i class="fas fa-cart-plus"></i></a>
        ...
        <div class="container mt-4">
            <div class="row">
                <c:forEach var="p" items="${productos}">
                    <c:if test="${p.getEstado() == 'ACTIVO'}">
                        <c:if test="${p.getNombres() == 'Procesador Edicion'}">
                            <c:if test="${p.getCategoria() == 'EDICION'}">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="card">
        ...
        <div class="container mt-4">
            <div class="row">
                <c:forEach var="p" items="${productos}">
                    <c:if test="${p.getEstado() == 'ACTIVO'}">
                        <c:if test="${p.getNombres() == 'RAM Edicion'}">
                            <c:if test="${p.getCategoria() == 'EDICION'}">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="card">
        ...
        <div class="container mt-4">
            <div class="row">
                <c:forEach var="p" items="${productos}">
                    <c:if test="${p.getEstado() == 'ACTIVO'}">
                        <c:if test="${p.getNombres() == 'Disco duro SSD KINSTOM'}">
                            <c:if test="${p.getCategoria() == 'EDICION'}">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="card">
        ...
        <div class="container mt-4">
            <div class="row">
                <c:forEach var="p" items="${productos}">
                    <c:if test="${p.getEstado() == 'ACTIVO'}">
                        <c:if test="${p.getNombres() == 'Fuente de Poder de Edicion'}">
                            <c:if test="${p.getCategoria() == 'EDICION'}">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="card">
        ...
        <div class="container mt-4">
            <div class="row">
                <c:forEach var="p" items="${productos}">
                    <c:if test="${p.getEstado() == 'ACTIVO'}">
                        <c:if test="${p.getNombres() == 'RGB TORRE'}">
                            <c:if test="${p.getCategoria() == 'EDICION'}">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="card">
        ...
        <div class="container mt-4">
            <div class="row">
                <c:forEach var="p" items="${productos}">
                    <c:if test="${p.getEstado() == 'ACTIVO'}">
                        <c:if test="${p.getNombres() == 'Monitor'}">
                            <c:if test="${p.getCategoria() == 'EDICION'}">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="card">
