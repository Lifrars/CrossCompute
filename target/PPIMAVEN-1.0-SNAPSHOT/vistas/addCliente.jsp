            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="Controlador?accion=GuardarCliente" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>Dni</label>
                                    <textarea name="txtDni" class="form-control" required></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <button class="btn btn-danger" name="accion" value="GuardarCliente">Guardar</button>
                                </div>
                            </form>
                            <form action="Controlador?accion=Eliminarzap">
                                <button class="btn btn-info" name="accion" value="Eliminarzap">Eliminar Zap</button>
                            </form>
                        </div>               
                    </div>
                </div> 
                                ...
                                <tr class="text-center tr">
                                    ...
                                    <td class="d-flex">
                                        <form action="Controlador">
                                            ...
                                            <button type="submit" class="btn btn-warning"name="accion" value="ClientEditar">Editar</button>
