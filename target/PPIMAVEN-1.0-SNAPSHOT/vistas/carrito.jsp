...
<%@page import="Controlador.ControladorImg"%>
<%@page import="java.text.DateFormat"%>
<%@page import="java.util.Locale"%>
<%@page import="ConexionBD.Fecha"%>
...
<html>
    ...
    <body>      
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <a class="navbar-brand" href="#"><i>Carrito de Compras</i></a>
                            ...
                            <c:forEach var="c" items="${Carrito}"> 
                                <tr class="text-center tr">
                                    ...
                                    <td>        
                                        ...
                                        <input type="number" min="1" max="${c.getStock()}"  id="Cant" class=" form-control text-center" value="${c.getCantidad()}">
                                    </td>   
                                    <td>${c.getSubTotal()}</td>                           
        ...
        <div class="modal fade" id="myModalPago" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">         
                <div class="modal-content">                   
                    <div class="modal-header text-center"> 
                        <label><i class="fas fa-dollar-sign"></i> Realizar Pago</label>
                        <button type="button" class="close" data-dismiss="modal">
                            <span aria-hidden="true">&times;</span>
                        </button>  
                    </div>
