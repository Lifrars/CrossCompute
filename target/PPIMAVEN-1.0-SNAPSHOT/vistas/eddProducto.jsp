            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="Controlador" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>Nombres:</label>
                                    <input type="textarea" name="txtNombree" class="form-control"value="${Nombres}" required>
                                </div>                     
                                <div class="form-group">
                                    <label>Descripcion</label>
                                    <input name="txtDescripcione" class="form-control"value="${Descripcion}" required>
                                </div>
                                <div class="form-group">
                                    <label>Precio</label>
                                    <input type="text" name="txtPrecioe" class="form-control"value="${Precio}" required>
                                </div>
                                <div class="form-group">
                                    <label>Stock</label>
                                    <input type="text" name="txtStocke" class="form-control" value="${Stock}"required>
                                </div>
                                <div class="form-group">
                                    <label>Categoria</label>
                                    <input type="text" name="txtcategoria" class="form-control" value="${categoria}"required>
                                </div>
                                <div class="form-group">
                                    <button class="btn btn-danger" name="accion" value="Cancelar">Cancelar</button>
                                    <button class="btn btn-info" name="accion" value="Confirmar">Confirmar</button>
                                </div>
                            </form>
                        </div>               
                    </div>
